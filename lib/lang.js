export const lang = {
  ...
  fr: {
    ...
    LAYOUT: {
      NOTICE_TEXT: 'Si vous avez un question, vous pouvez me contacter.',
      PAY_BUTTON: 'Coffee',
      NOTICE_BUTTON: 'Contact',
      COMMENT_TITLE: 'Commentaire'
    },
    SEARCH: {
      ONLY_SEARCH: 'Rechercher uniquement par tag',
      PLACEHOLDER: 'Recherches dans les publications',
      NOT_FOUND: 'Pas de publication'
    },
    HERO: {
      HOME: {
        CONTACT_BUTTON: 'Contact',
      ...
      NEWSLETTER: {
        ...
        TG_CHANNEL: 'Cannal Telegram',
        RSS_BUTTON: 'Souscrire au flux RSS'
      },
      NOTES: {
        TEXT_FOOTER: 'Automatically generated from the Craft.do page'
      },
    ...
    CONTACT: {
      TITLE: 'Contact',
      DESCRIPTION:
        'Si vous avez une question ou une suggestion, vous pouvez me contacter.',
      TG_DESCRIPTION: 'Ou me contacter par Telegram ',
      SUCCESS_MESSAGE: 'Message envoyé, vous recevrez une réponse dans les plus brefs délais',
      FORM_USERNAME: 'Votre nom',
      FORM_EMAIL: 'Votre adresse email*',
      FORM_CONTENT: 'Message',
      SEND_BUTTON: 'Envoyer',
      FORM_EMAIL_REQUIRED: "*Vous pouvez renseigner d'autres moyens de communication",
      FAILED_MESSAGE:
        "L'envoi du message a échoué. Vous pouvez me contacter par Telegram"
    },
    FOOTER: {
      COPYRIGHT_START: 'Ce site est sous la license ',
      COPYRIGHT_NAME: 'CC BY-SA 4.0',
      COPYRIGHT_LINK: 'https://creativecommons.org/licenses/by-sa/4.0/',
      COPYRIGHT_END: '.'
    },
    ERROR: {
      ...
      HELP_TEXT:
        "Veuillez rafraîchir la page, retourner sur la page d'accueil ou me contacter",
      BACK_TO_HOME: "Page d'accueil",
      CRAFTDOCS_ERROR:
        'If you see this line, it means your Craft.do configuration page format is wrong.',
      LOADING: 'Chargement....',
      TIMEOUT_TEXT: 'Le chargement est trop long? Vous pouvez trouver la page Notion dircectement.'
    }
  },
  ja: {},
  es: {}
