var app = function () {
  ...
  function B(e, t) {
    const r = e.$$
    null !== r.fragment && (s(r.on_destroy), r.fragment && r.fragment.d(t), r.on_destroy = r.fragment = null, r.ctx = [])
  }

  function L(e, t) {
    -1 === e.$$.dirty[0] && (k.push(e), S || (S = !0, O.then(A)), e.$$.dirty.fill(0)), e.$$.dirty[t / 31 | 0] |= 1 << t % 31
  }
  ...
  function M(t, r, i, o, a, c, u, l = [-1]) {
    ...
    if (p.ctx = i ? i(t, r.props || {}, ((e, r, ...n) => {
      ...
      return p.ctx && a(p.ctx[e], p.ctx[e] = s) && (!p.skip_bound && p.bound[e] && p.bound[e](s), m && L(t, e)), r
    ...
    return J(this, void 0, void 0, (function * () {
      return new Promise(((i, o) => {
        e(r, ((e, t, r) => {
          ...
          return 'GET' === e || (n.headers = Object.assign({ 'Content-Type': 'text/plain;charset=UTF-8' }, null == t ? void 0 : t.headers), n.body = JSON.stringify(r)), n
        })(t, n, s)).then((e => {
          if (!e.ok) throw e
  ...
  const V = { 'X-Client-Info': 'gotrue-js/1.22.12' }, X = 'supabase.auth.token', Y = {
    name: 'sb',
    lifetime: 28800,
    domain: '',
    path: '/',
  ...
  function Q(e, t) {
    ...
    return function (e, t, r) {
      const n = r || {}, s = encodeURIComponent, i = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/
  ...
  var ne, se, ie = (ne = function (e, t) {
    var r = 'undefined' != typeof self ? self : te, n = function () {
      function e() {
    ...
    !function (e) {
      !function (t) {
        var r = 'URLSearchParams' in e, n = 'Symbol' in e && 'iterator' in Symbol, s = 'FileReader' in e && 'Blob' in e && function () {
          try {
            return new Blob, !0
          } catch (e) {
            return !1
        ...
        function b(e, t) {
          ...
          if (e instanceof b) {
            ...
            this.url = e.url, this.credentials = e.credentials, t.headers || (this.headers = new d(e.headers)), this.method = e.method, this.mode = e.mode, this.signal = e.signal, s || null == e._bodyInit || (s = e._bodyInit, e.bodyUsed = !0)
          } else {
            this.url = String(e)
          }
          if (this.credentials = t.credentials || this.credentials || 'same-origin', !t.headers && this.headers || (this.headers = new d(t.headers)), this.method = (r = t.method || this.method || 'GET', n = r.toUpperCase(), y.indexOf(n) > -1 ? n : r), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal, this.referrer = null, ('GET' === this.method || 'HEAD' === this.method) && s) throw new TypeError('Body not allowed for GET or HEAD requests')
          this._initBody(s)
        }
        ...
        function _(e) {
          ...
          return e.trim().split('&').forEach((function (e) {
            if (e) {
              var r = e.split('='), n = r.shift().replace(/\+/g, ' '), s = r.join('=').replace(/\+/g, ' ')
        ...
        T.polyfill = !0, e.fetch || (e.fetch = T, e.Headers = d, e.Request = b, e.Response = w), t.Headers = d, t.Request = b, t.Response = w, t.fetch = T, Object.defineProperty(t, '__esModule', { value: !0 })
      }({})
  ...
  }, ne(se = { exports: {} }, se.exports), se.exports), oe = re(ie)
  ...
  class de {
    constructor({
      ...
      this.url = e, this.headers = t, this.cookieOptions = Object.assign(Object.assign({}, Y), r), this.fetch = ue(n)
    }
    ...
    signUpWithPhone(e, t, r = {}) {
      return le(this, void 0, void 0, (function * () {
        try {
          const n = Object.assign({}, this.headers), s = yield K(this.fetch, `${this.url}/signup`, {
            phone: e,
            password: t,
            data: r.data,
            gotrue_meta_security: { hcaptcha_token: r.captchaToken }
          }, { headers: n }), i = Object.assign({}, s)
    ...
    signInWithPhone(e, t) {
      return le(this, void 0, void 0, (function * () {
        try {
          const r = Object.assign({}, this.headers), n = '?grant_type=password', s = yield K(this.fetch, `${this.url}/token${n}`, {
            phone: e,
            password: t
          }, { headers: r }), i = Object.assign({}, s)
          return i.expires_in && (i.expires_at = ae(s.expires_in)), {
            data: i,
            error: null
          }
    ...
    signInWithOpenIDConnect({
      ...
      return le(this, void 0, void 0, (function * () {
        try {
          const i = Object.assign({}, this.headers), o = '?grant_type=id_token', a = yield K(this.fetch, `${this.url}/token${o}`, {
            id_token: e,
            nonce: t,
            client_id: r,
            issuer: n,
            provider: s
          }, { headers: i }), h = Object.assign({}, a)
    ...
    sendMobileOTP(e, t = {}) {
      ...
      return le(this, void 0, void 0, (function * () {
        try {
          const n = null === (r = t.shouldCreateUser) || void 0 === r || r, s = Object.assign({}, this.headers)
          return {
    ...
    verifyMobileOTP(e, t, r = {}) {
      return le(this, void 0, void 0, (function * () {
        try {
          const n = Object.assign({}, this.headers), s = yield K(this.fetch, `${this.url}/verify`, {
            phone: e,
            token: t,
            type: 'sms',
    ...
    verifyOTP({
      ...
      return le(this, void 0, void 0, (function * () {
        try {
          const i = Object.assign({}, this.headers), o = yield K(this.fetch, `${this.url}/verify`, {
            email: e,
            phone: t,
            token: r,
            type: n,
            redirect_to: s.redirectTo
          }, { headers: i }), a = Object.assign({}, o)
    ...
    refreshAccessToken(e) {
      return le(this, void 0, void 0, (function * () {
        try {
          const t = yield K(this.fetch, `${this.url}/token?grant_type=refresh_token`, { refresh_token: e }, { headers: this.headers }), r = Object.assign({}, t)
    ...
    createUser(e) {
      return le(this, void 0, void 0, (function * () {
        try {
          const t = yield K(this.fetch, `${this.url}/admin/users`, e, { headers: this.headers })
          return {
            user: t,
            data: t,
            error: null
    ...
    listUsers() {
      return le(this, void 0, void 0, (function * () {
        try {
          return {
            data: (yield z(this.fetch, `${this.url}/admin/users`, { headers: this.headers })).users,
            error: null
          }
        } catch (e) {
          return {
    ...
    getUserById(e) {
      return le(this, void 0, void 0, (function * () {
        try {
          return {
            data: yield z(this.fetch, `${this.url}/admin/users/${e}`, { headers: this.headers }),
            error: null
          }
        } catch (e) {
          return {
    ...
    getUserByCookie(e, t) {
      return le(this, void 0, void 0, (function * () {
        try {
          ...
          const r = e.cookies[`${this.cookieName()}-access-token`], n = e.cookies[`${this.cookieName()}-refresh-token`]
          ...
          if (i) {
            ...
            if (!t) throw new Error('You need to pass the res object to automatically refresh the session!')
            const {
              data: r,
              error: s
    ...
    updateUserById(e, t) {
      return le(this, void 0, void 0, (function * () {
        try {
          const r = yield W(this.fetch, `${this.url}/admin/users/${e}`, t, { headers: this.headers })
          return {
            user: r,
            data: r,
            error: null
    ...
    getUser(e) {
      return le(this, void 0, void 0, (function * () {
        try {
          const t = yield z(this.fetch, `${this.url}/user`, { headers: this._createRequestHeaders(e) })
          return {
            user: t,
            data: t,
            error: null
    ...
    updateUser(e, t) {
      return le(this, void 0, void 0, (function * () {
        try {
          const r = yield W(this.fetch, `${this.url}/user`, t, { headers: this._createRequestHeaders(e) })
          return {
            user: r,
            data: r,
            error: null
  ...
  class me extends class {
    constructor(e) {
      ...
      this.currentUser = null, this.currentSession = null, this.autoRefreshToken = t.autoRefreshToken, this.persistSession = t.persistSession, this.multiTab = t.multiTab, this.localStorage = t.localStorage || globalThis.localStorage, this.api = new de({
        url: t.url,
        headers: t.headers,
        cookieOptions: t.cookieOptions,
        fetch: t.fetch
      }), this._recoverSession(), this._recoverAndRefresh(), this._listenForMultiTabEvents(), t.detectSessionInUrl && he() && ce('access_token') && this.getSessionFromUrl({ storeSession: !0 }).then((({ error: e }) => {
    ...
    signUp({
      ...
      return fe(this, void 0, void 0, (function * () {
        try {
          ...
          let o = null, a = null
          return s.access_token && (o = s, a = o.user, this._saveSession(o), this._notifyAllSubscribers('SIGNED_IN')), s.id && (a = s), {
            user: a,
            session: o,
            error: null
          }
    ...
    verifyOTP(e, t = {}) {
      return fe(this, void 0, void 0, (function * () {
        try {
          ...
          let s = null, i = null
          return r.access_token && (s = r, i = s.user, this._saveSession(s), this._notifyAllSubscribers('SIGNED_IN')), r.id && (i = r), {
            user: i,
            session: s,
            error: null
          }
    ...
    getSessionFromUrl(e) {
      return fe(this, void 0, void 0, (function * () {
        try {
          ...
          const r = ce('provider_token'), n = ce('access_token')
      ...
      return fe(this, void 0, void 0, (function * () {
        try {
          const {
            data: i,
            error: o
          } = yield this.api.signInWithEmail(e, t, { redirectTo: r.redirectTo })
          return o || !i ? {
            data: null,
            user: null,
            session: null,
            error: o
          } : (((null === (n = null == i ? void 0 : i.user) || void 0 === n ? void 0 : n.confirmed_at) || (null === (s = null == i ? void 0 : i.user) || void 0 === s ? void 0 : s.email_confirmed_at)) && (this._saveSession(i), this._notifyAllSubscribers('SIGNED_IN')), {
            data: i,
            user: i.user,
            session: i,
            error: null
      ...
      return fe(this, void 0, void 0, (function * () {
        try {
          ...
          return s || !n ? {
            ...
            session: null,
            error: s
          } : ((null === (r = null == n ? void 0 : n.user) || void 0 === r ? void 0 : r.phone_confirmed_at) && (this._saveSession(n), this._notifyAllSubscribers('SIGNED_IN')), {
            data: n,
            user: n.user,
            session: n,
            error: null
    ...
    _recoverSession() {
      ...
      try {
        ...
        s >= Math.round(Date.now() / 1e3) && (null == n ? void 0 : n.user) && (this._saveSession(n), this._notifyAllSubscribers('SIGNED_IN'))
      } catch (e) {
        console.log('error', e)
      }
    }
      ...
      return fe(this, void 0, void 0, (function * () {
        try {
          ...
          if (n < Math.round(Date.now() / 1e3)) {
            ...
            r ? (this._saveSession(r), this._notifyAllSubscribers('SIGNED_IN')) : (console.log('Current session is missing data.'), this._removeSession())
          }
        } catch (e) {
    ...
    _callRefreshToken(e) {
      var t
      return void 0 === e && (e = null === (t = this.currentSession) || void 0 === t ? void 0 : t.refresh_token), fe(this, void 0, void 0, (function * () {
        try {
          if (!e) throw new Error('No current session.')
          const {
            data: t,
    ...
    _saveSession(e) {
      ...
      if (t) {
        const e = t - Math.round(Date.now() / 1e3), r = e > 60 ? 60 : .5
    ...
    _removeSession() {
      return fe(this, void 0, void 0, (function * () {
        this.currentSession = null, this.currentUser = null, this.refreshTokenTimer && clearTimeout(this.refreshTokenTimer), he() && (yield this.localStorage.removeItem(X))
      }))
    }

    _startAutoRefreshToken(e) {
      this.refreshTokenTimer && clearTimeout(this.refreshTokenTimer), e <= 0 || !this.autoRefreshToken || (this.refreshTokenTimer = setTimeout((() => this._callRefreshToken()), e), 'function' == typeof this.refreshTokenTimer.unref && this.refreshTokenTimer.unref())
    }

    _listenForMultiTabEvents() {
      if (!this.multiTab || !he() || !(null === window || void 0 === window ? void 0 : window.addEventListener)) return !1
      try {
  ...
  class ve {
    constructor(e) {
      let t
      Object.assign(this, e), t = e.fetch ? e.fetch : 'undefined' == typeof fetch ? oe : fetch, this.fetch = (...e) => t(...e), this.shouldThrowOnError = e.shouldThrowOnError || !1
    }
    ...
    then(e, t) {
      ...
      let r = this.fetch(this.url.toString(), {
        ...
        if (e.ok) {
          const s = null === (t = this.headers.Prefer) || void 0 === t ? void 0 : t.split(',').includes('return=minimal')
          ...
          const a = null === (r = this.headers.Prefer) || void 0 === r ? void 0 : r.match(/count=(exact|planned|estimated)/),
            h = null === (n = e.headers.get('content-range')) || void 0 === n ? void 0 : n.split('/')
  ...
  class ye extends ve {
    ...
    order(e, {
      ...
      const s = void 0 === n ? 'order' : `${n}.order`, i = this.url.searchParams.get(s)
      return this.url.searchParams.set(s, `${i ? `${i},` : ''}${e}.${t ? 'asc' : 'desc'}.${r ? 'nullsfirst' : 'nullslast'}`), this
    }
    ...
    range(e, t, { foreignTable: r } = {}) {
      const n = void 0 === r ? 'offset' : `${r}.offset`, s = void 0 === r ? 'limit' : `${r}.limit`
    ...
    maybeSingle() {
      ...
      return e.then = (e, t) => this.then((t => {
        var r, n
        return (null === (n = null === (r = t.error) || void 0 === r ? void 0 : r.details) || void 0 === n ? void 0 : n.includes('Results contain 0 rows')) ? e({
          error: null,
          data: null,
          count: t.count,
          status: 200,
  ...
  class _e extends ve {
    ...
    select(e = '*', {
      ...
      return this.url.searchParams.set('select', s), r && (this.headers.Prefer = `count=${r}`), t && (this.method = 'HEAD'), new be(this)
    }
    ...
    insert(e, {
      ...
      this.method = 'POST'
      const i = [`return=${n}`]
      if (t && i.push('resolution=merge-duplicates'), t && void 0 !== r && this.url.searchParams.set('on_conflict', r), this.body = e, s && i.push(`count=${s}`), this.headers.Prefer && i.unshift(this.headers.Prefer), this.headers.Prefer = i.join(','), Array.isArray(e)) {
    ...
    upsert(e, {
      ...
      return void 0 !== t && this.url.searchParams.set('on_conflict', t), this.body = e, n && i.push(`count=${n}`), this.headers.Prefer && i.unshift(this.headers.Prefer), this.headers.Prefer = i.join(','), new be(this)
    }
    ...
    update(e, {
      ...
      this.method = 'PATCH'
      const n = [`return=${t}`]
      return this.body = e, r && n.push(`count=${r}`), this.headers.Prefer && n.unshift(this.headers.Prefer), this.headers.Prefer = n.join(','), new be(this)
    }
    ...
    delete({
      ...
      this.method = 'DELETE'
      const r = [`return=${e}`]
      return t && r.push(`count=${t}`), this.headers.Prefer && r.unshift(this.headers.Prefer), this.headers.Prefer = r.join(','), new be(this)
    }
  }
  ...
  class we extends ve {
    ...
    rpc(e, {
      ...
      }))) : (this.method = 'POST', this.body = e), r && (void 0 !== this.headers.Prefer ? this.headers.Prefer += `,count=${r}` : this.headers.Prefer = `count=${r}`), new be(this)
    }
  }
  ...
  class Te {
    constructor(e, {
      ...
      this.url = e, this.headers = Object.assign(Object.assign({}, ke), t), this.schema = r, this.fetch = n, this.shouldThrowOnError = s
    }
  ...
  const Ee = (e, t, r = {}) => {
    ...
    const s = t.find((t => t.name === e)), i = null == s ? void 0 : s.type, o = r[e]
  ...
  if ('object' == typeof globalThis) {
    ...
    try {
      ...
      if (Ce || 'undefined' == typeof window || (Ce = window), !Ce) throw new Error('Could not determine global this')
    }
  }
  ...
  class Ke {
    ...
    _decodeBroadcast(e, t, r) {
      const n = t.getUint8(1), s = t.getUint8(2)
  ...
  class We {
    ...
    startTimeout() {
      ...
      this.channel instanceof Ve ? this.channel.on(this.refEvent, e) : this.channel.on(this.refEvent, {}, e), this.timeoutTimer = setTimeout((() => {
    ...
    _cancelRefEvent() {
      this.refEvent && (this.channel instanceof Ve ? this.channel.off(this.refEvent) : this.channel.off(this.refEvent, {}))
    }
  ...
  class Ve {
    constructor(e, t = {}, r) {
      this.topic = e, this.params = t, this.socket = r, this.bindings = [], this.state = Je.closed, this.joinedOnce = !1, this.pushBuffer = [], this.timeout = this.socket.timeout, this.joinPush = new We(this, Ge.join, this.params, this.timeout), this.rejoinTimer = new ze((() => this.rejoinUntilConnected()), this.socket.reconnectAfterMs), this.joinPush.receive('ok', (() => {
        this.state = Je.joined, this.rejoinTimer.reset(), this.pushBuffer.forEach((e => e.send())), this.pushBuffer = []
      })), this.onClose((() => {
        this.rejoinTimer.reset(), this.socket.log('channel', `close ${this.topic} ${this.joinRef()}`), this.state = Je.closed, this.socket.remove(this)
      })), this.onError((e => {
        this.isLeaving() || this.isClosed() || (this.socket.log('channel', `error ${this.topic}`, e), this.state = Je.errored, this.rejoinTimer.scheduleTimeout())
      })), this.joinPush.receive('timeout', (() => {
        this.isJoining() && (this.socket.log('channel', `timeout ${this.topic}`, this.joinPush.timeout), this.state = Je.errored, this.rejoinTimer.scheduleTimeout())
    ...
    rejoin(e = this.timeout) {
      this.isLeaving() || (this.socket.leaveOpenTopic(this.topic), this.state = Je.joining, this.joinPush.resend(e))
    }
  ...
  class Xe {
    constructor(e, t) {
      ...
      this.channel.on(r.state, {}, (e => {
        ...
        this.joinRef = this.channel.joinRef(), this.state = Xe.syncState(this.state, e, t, r), this.pendingDiffs.forEach((e => {
        ...
        this.inPendingSyncState() ? this.pendingDiffs.push(e) : (this.state = Xe.syncDiff(this.state, e, t, r), n())
      }))
    }

    static syncState(e, t, r, n) {
      const s = this.cloneDeep(e), i = this.transformState(t), o = {}, a = {}
      return this.map(s, ((e, t) => {
        i[e] || (a[e] = t)
      })), this.map(i, ((e, t) => {
        const r = s[e]
        if (r) {
          const n = t.map((e => e.presence_id)), s = r.map((e => e.presence_id)), i = t.filter((e => s.indexOf(e.presence_id) < 0)), h = r.filter((e => n.indexOf(e.presence_id) < 0))
    ...
    static syncDiff(e, t, r, n) {
      ...
      return r || (r = () => {
        ...
        if (e[t] = this.cloneDeep(n), s) {
          const r = e[t].map((e => e.presence_id)), n = s.filter((e => r.indexOf(e.presence_id) < 0))
          e[t].unshift(...n)
        }
        r(t, s, n)
      })), this.map(i, ((t, r) => {
        ...
        s = s.filter((e => i.indexOf(e.presence_id) < 0)), e[t] = s, n(t, s, r), 0 === s.length && delete e[t]
      })), e
    }
    ...
    static transformState(e) {
      return e = this.cloneDeep(e), Object.getOwnPropertyNames(e).reduce(((t, r) => {
        const n = e[r]
        return t[r] = 'metas' in n ? n.metas.map((e => (e.presence_id = e.phx_ref, delete e.phx_ref, delete e.phx_ref_prev, e))) : n, t
      }), {})
    }
  ...
  class Ye {
    ...
    subscribe(e = this.timeout) {
      if (this.joinedOnce) throw'tried to subscribe multiple times. \'subscribe\' can only be called a single time per channel instance'
      {
        const t = this.bindings.reduce(((e, t) => {
          const { type: r } = t
          return ['phx_close', 'phx_error', 'phx_reply', 'presence_diff', 'presence_state'].includes(r) || (e[r] = t), e
        }), {})
        return Object.keys(t).length && this.updateJoinPayload({ configs: t }), this.joinedOnce = !0, this.rejoin(e), this.joinPush
      }
    }
    ...
    trigger(e, t, r) {
      ...
      this.bindings.filter((r => {
        var n, s
        return (null == r ? void 0 : r.type) === e && ('*' === (null === (n = null == r ? void 0 : r.eventFilter) || void 0 === n ? void 0 : n.event) || (null === (s = null == r ? void 0 : r.eventFilter) || void 0 === s ? void 0 : s.event) === (null == t ? void 0 : t.event))
  ...
  class tt {
    constructor(e, t) {
      this.accessToken = null, this.channels = [], this.endPoint = '', this.headers = Fe, this.params = {}, this.timeout = 1e4, this.transport = Me.w3cwebsocket, this.heartbeatIntervalMs = 3e4, this.longpollerTimeout = 2e4, this.heartbeatTimer = void 0, this.pendingHeartbeatRef = null, this.ref = 0, this.logger = et, this.conn = null, this.sendBuffer = [], this.serializer = new Ke, this.stateChangeCallbacks = {
        open: [],
        close: [],
        error: [],
        message: []
      }, this.endPoint = `${e}/${qe.websocket}`, (null == t ? void 0 : t.params) && (this.params = t.params), (null == t ? void 0 : t.headers) && (this.headers = Object.assign(Object.assign({}, this.headers), t.headers)), (null == t ? void 0 : t.timeout) && (this.timeout = t.timeout), (null == t ? void 0 : t.logger) && (this.logger = t.logger), (null == t ? void 0 : t.transport) && (this.transport = t.transport), (null == t ? void 0 : t.heartbeatIntervalMs) && (this.heartbeatIntervalMs = t.heartbeatIntervalMs), (null == t ? void 0 : t.longpollerTimeout) && (this.longpollerTimeout = t.longpollerTimeout), this.reconnectAfterMs = (null == t ? void 0 : t.reconnectAfterMs) ? t.reconnectAfterMs : e => [1e3, 2e3, 5e3, 1e4][e - 1] || 1e4, this.encode = (null == t ? void 0 : t.encode) ? t.encode : (e, t) => t(JSON.stringify(e)), this.decode = (null == t ? void 0 : t.decode) ? t.decode : this.serializer.decode.bind(this.serializer), this.reconnectTimer = new ze((() => Qe(this, void 0, void 0, (function * () {
    ...
    disconnect(e, t) {
      return new Promise(((r, n) => {
        try {
          ...
          }, e ? this.conn.close(e, t || '') : this.conn.close(), this.conn = null, this.heartbeatTimer && clearInterval(this.heartbeatTimer), this.reconnectTimer.reset()), r({
            error: null,
            data: !0
          })
        } catch (e) {
    ...
    channel(e, t = { isNewVersion: !1 }) {
      const { isNewVersion: r } = t, n = Ze(t, ['isNewVersion']), s = r ? new Ye(e, Object.assign({}, n), this) : new Ve(e, Object.assign({}, n), this)
    ...
    onConnMessage(e) {
      this.decode(e.data, (e => {
        ...
        (s && s === this.pendingHeartbeatRef || r === (null == n ? void 0 : n.type)) && (this.pendingHeartbeatRef = null), this.log('receive', `${n.status || ''} ${t} ${r} ${s && '(' + s + ')' || ''}`, n), this.channels.filter((e => e.isMember(t))).forEach((e => e.trigger(r, n, s))), this.stateChangeCallbacks.message.forEach((t => t(e)))
      }))
    }
    ...
    setAuth(e) {
      ...
      try {
        this.channels.forEach((t => {
          e && t.updateJoinPayload({ user_token: e }), t.joinedOnce && t.isJoined() && t.push(Ge.access_token, { access_token: e })
        }))
      } catch (e) {
    ...
    _onConnOpen() {
      this.log('transport', `connected to ${this.endPointURL()}`), this._flushSendBuffer(), this.reconnectTimer.reset(), this.heartbeatTimer && clearInterval(this.heartbeatTimer), this.heartbeatTimer = setInterval((() => this._sendHeartbeat()), this.heartbeatIntervalMs), this.stateChangeCallbacks.open.forEach((e => e()))
    }
  ...
  class rt {
    constructor(e, t, r, n) {
      const s = {}, i = '*' === n ? `realtime:${r}` : `realtime:${r}:${n}`, o = t.Authorization.split(' ')[1]
    ...
    getPayloadRecords(e) {
      ...
      return 'INSERT' !== e.type && 'UPDATE' !== e.type || (t.new = Ee(e.columns, e.record)), 'UPDATE' !== e.type && 'DELETE' !== e.type || (t.old = Ee(e.columns, e.old_record)), t
    }
  ...
  class nt extends _e {
    constructor(e, {
      ...
      super(e, {
        ...
        fetch: i,
        shouldThrowOnError: o
      }), this._subscription = null, this._realtime = n, this._headers = t, this._schema = r, this._table = s
    }

    on(e, t) {
      return this._realtime.isConnected() || this._realtime.connect(), this._subscription || (this._subscription = new rt(this._realtime, this._headers, this._schema, this._table)), this._subscription.on(e, t)
    }
  }
    ...
    return it(this, void 0, void 0, (function * () {
      return new Promise(((o, a) => {
        e(r, ((e, t, r, n) => {
          ...
          return 'GET' === e ? s : (s.headers = Object.assign({ 'Content-Type': 'application/json' }, null == t ? void 0 : t.headers), s.body = JSON.stringify(n), Object.assign(Object.assign({}, s), r))
        })(t, n, s, i)).then((e => {
          if (!e.ok) throw e
  ...
  class gt {
    ...
    uploadOrUpdate(e, t, r, n) {
      return ft(this, void 0, void 0, (function * () {
        try {
          let s
          const i = Object.assign(Object.assign({}, mt), n), o = Object.assign(Object.assign({}, this.headers), 'POST' === e && { 'x-upsert': String(i.upsert) })
          'undefined' != typeof Blob && r instanceof Blob ? (s = new FormData, s.append('cacheControl', i.cacheControl), s.append('', r)) : 'undefined' != typeof FormData && r instanceof FormData ? (s = r, s.append('cacheControl', i.cacheControl)) : (s = r, o['cache-control'] = `max-age=${i.cacheControl}`, o['content-type'] = i.contentType)
          const a = this._removeEmptyFolders(t), h = this._getFinalPath(a), c = yield this.fetch(`${this.url}/object/${h}`, {
            method: e,
            body: s,
            headers: o
          })
    ...
    createSignedUrl(e, t) {
      return ft(this, void 0, void 0, (function * () {
        try {
          ...
          let n = yield ct(this.fetch, `${this.url}/object/sign/${r}`, { expiresIn: t }, { headers: this.headers })
          const s = `${this.url}${n.signedURL}`
          return n = { signedURL: s }, {
            data: n,
            error: null,
            signedURL: s
          }
        ...
        try {
          return {
            data: (yield ct(this.fetch, `${this.url}/object/sign/${this.bucketId}`, {
              expiresIn: t,
              paths: e
            }, { headers: this.headers })).map((e => Object.assign(Object.assign({}, e), { signedURL: e.signedURL ? `${this.url}${e.signedURL}` : null }))),
            error: null
          }
        } catch (e) {
          return {
    ...
    download(e) {
      return ft(this, void 0, void 0, (function * () {
        try {
          const t = this._getFinalPath(e), r = yield ht(this.fetch, `${this.url}/object/${t}`, {
            headers: this.headers,
            noResolveJson: !0
          })
          return {
    ...
    remove(e) {
      return ft(this, void 0, void 0, (function * () {
        try {
          return {
            data: yield ut(this.fetch, `${this.url}/object/${this.bucketId}`, { prefixes: e }, { headers: this.headers }),
            error: null
          }
        } catch (e) {
          return {
    ...
    list(e, t, r) {
      return ft(this, void 0, void 0, (function * () {
        try {
          const n = Object.assign(Object.assign(Object.assign({}, pt), t), { prefix: e || '' })
          return {
            data: yield ct(this.fetch, `${this.url}/object/list/${this.bucketId}`, n, { headers: this.headers }, r),
            error: null
          }
        } catch (e) {
          return {
  ...
  class vt extends class {
    ...
    listBuckets() {
      return dt(this, void 0, void 0, (function * () {
        try {
          return {
            data: yield ht(this.fetch, `${this.url}/bucket`, { headers: this.headers }),
            error: null
          }
        } catch (e) {
          return {
    ...
    getBucket(e) {
      return dt(this, void 0, void 0, (function * () {
        try {
          return {
            data: yield ht(this.fetch, `${this.url}/bucket/${e}`, { headers: this.headers }),
            error: null
          }
        } catch (e) {
          return {
    ...
    deleteBucket(e) {
      return dt(this, void 0, void 0, (function * () {
        try {
          return {
            data: yield ut(this.fetch, `${this.url}/bucket/${e}`, {}, { headers: this.headers }),
            error: null
          }
        } catch (e) {
          return {
    ...
    invoke(e, t) {
      return yt(this, void 0, void 0, (function * () {
        try {
          ...
          return o = a && 'json' !== a ? 'arrayBuffer' === a ? yield s.arrayBuffer() : 'blob' === a ? yield s.blob() : yield s.text() : yield s.json(), {
            data: o,
            error: null
          }
        } catch (e) {
  ...
  class kt {
    ...
    removeAllSubscriptions() {
      return _t(this, void 0, void 0, (function * () {
        const e = this.getSubscriptions().slice(), t = e.map((e => this.removeSubscription(e)))
    ...
    removeSubscription(e) {
      return _t(this, void 0, void 0, (function * () {
        const { error: t } = yield this._closeSubscription(e), r = this.getSubscriptions(), n = r.filter((e => e.isJoined())).length
        return 0 === r.length && (yield this.realtime.disconnect()), {
          data: { openSubscriptions: n },
          error: t
        }
      }))
    }
    ...
    _unsubscribeSubscription(e) {
      return new Promise((t => {
        e.unsubscribe().receive('ok', (() => t({ error: null }))).receive('error', (e => t({ error: e }))).receive('timeout', (() => t({ error: new Error('timed out') })))
      }))
    }
    ...
    _initRealtimeClient(e) {
      return new tt(this.realtimeUrl, Object.assign(Object.assign({}, e), { params: Object.assign(Object.assign({}, null == e ? void 0 : e.params), { apikey: this.supabaseKey }) }))
    }
    ...
    _getAuthHeaders() {
      var e, t
      const r = Object.assign({}, this.headers), n = null !== (t = null === (e = this.auth.session()) || void 0 === e ? void 0 : e.access_token) && void 0 !== t ? t : this.supabaseKey
      return r.apikey = this.supabaseKey, r.Authorization = r.Authorization || `Bearer ${n}`, r
    }

    _listenForMultiTabEvents() {
      if (!this.multiTab || 'undefined' == typeof window || !(null === window || void 0 === window ? void 0 : window.addEventListener)) return null
      try {
        return null === window || void 0 === window ? void 0 : window.addEventListener('storage', (e => {
          var t, r, n
          if ('supabase.auth.token' === e.key) {
            const s = JSON.parse(String(e.newValue)), i = null !== (r = null === (t = null == s ? void 0 : s.currentSession) || void 0 === t ? void 0 : t.access_token) && void 0 !== r ? r : void 0,
  ...
  function At(e) {
    for (var t = [], r = 0; r < 64; r += 4) t[r >> 2] = e.charCodeAt(r) + (e.charCodeAt(r + 1) << 8) + (e.charCodeAt(r + 2) << 16) + (e.charCodeAt(r + 3) << 24)
    return t
  }
  ...
  var Ct = function (e) {
    return function (e) {
      ...
      var t, r = e.length, n = [1732584193, -271733879, -1732584194, 271733878]
      ...
      if (s[t >> 2] |= 128 << (t % 4 << 3), t > 55) for (Et(n, s), t = 0; t < 16; t++) s[t] = 0
  ...
  var Nt = Object.defineProperty({ md5: Ct }, '__esModule', { value: !0 }), Dt = te && te.__spreadArrays || function () {
    for (var e = 0, t = 0, r = arguments.length; t < r; t++) e += arguments[t].length
    var n = Array(e), s = 0
    for (t = 0; t < r; t++) for (var i = arguments[t], o = 0, a = i.length; o < a; o++, s++) n[s] = i[o]
    return n
  }
  ...
  function Ft(e, t, r) {
    var n = 300 - e
    return 'm 150 ' + (100 + t + 200 * r) + ' Q ' + n + ' ' + e + ' ' + (200 - t - 200 * r) + ' 150 Q ' + n + ' ' + n + ' 150 ' + (200 - t - 200 * r) + ' Q ' + e + ' ' + n + ' ' + (100 + t + 200 * r) + ' 150 Q ' + e + ' ' + e + ' 150 ' + (100 + t + 200 * r) + ' z'
  }
  ...
  var Jt = function (e) {
    var t = Nt.md5(e).split('').filter((function (e) {
      return '-' !== e
    })), r = t.splice(0, 6).join(''), n = t.splice(t.length - 6, t.length).join(''), s = Dt(Array(10)).map((function () {
      return parseInt(t.splice(0, 2).join(''), 16)
    }))
    return function (e) {
      return '<svg width="300" height="300" viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg"><rect id="bg" width="300" height="300" fill="rgb(' + Bt(e.background) + ')" /><path d="' + e.paths[0] + '" fill="rgb(' + Bt(e.colors[0]) + ')" /><path d="' + e.paths[1] + '" fill="rgb(' + Bt(e.colors[1]) + ')" /><path d="' + e.paths[2] + '" fill="rgb(' + Bt(e.colors[2]) + ')" /></svg>'
    }({
  ...
  }, '__esModule', { value: !0 }).generateFromString
  ...
  function Kt(e) {
    let t, r, n, s, i, o, a, h, u, v, _, w, k, T, $, E = e[4].name + '', O = Vt(e[4].created_at, 'zh') + '', S = e[4].comment + ''
    return {
      c() {
        t = p('div'), r = p('div'), n = p('img'), i = g(), o = p('div'), a = p('strong'), h = m(E), u = g(), v = p('span'), _ = m(O), w = g(), k = p('p'), T = m(S), $ = g(), y(n, 'alt', 'avatar'), y(n, 'class', 'mt-2 rounded-full w-8 h-8 sm:w-10 sm:h-10'), c(n.src, s = `data:image/svg+xml;utf8,${Gt(e[4].email || e[4].name)}`) || y(n, 'src', s), y(r, 'class', 'flex-shrink-0 mr-3'), y(v, 'class', 'text-xs text-gray-400'), y(k, 'class', 'text-sm'), y(o, 'class', 'w-full bg-gray-100 dark:bg-gray-700 rounded-lg px-4 py-2 sm:px-6 sm:py-4 leading-relaxed'), y(t, 'class', 'flex')
      },
      m(e, s) {
        d(e, t, s), l(t, r), l(r, n), l(t, i), l(t, o), l(o, a), l(a, h), l(o, u), l(o, v), l(v, _), l(o, w), l(o, k), l(k, T), l(t, $)
      },
      p(e, t) {
        8 & t && !c(n.src, s = `data:image/svg+xml;utf8,${Gt(e[4].email || e[4].name)}`) && y(n, 'src', s), 8 & t && E !== (E = e[4].name + '') && b(h, E), 8 & t && O !== (O = Vt(e[4].created_at, 'zh') + '') && b(_, O), 8 & t && S !== (S = e[4].comment + '') && b(T, S)
      },
      d(e) {
        e && f(t)
      }
  ...
  function Wt(t) {
    let r, n, i, o, a, h, c, u, m, b, w, k, T, $, E, O, S, x, j, P, A, R = t[0] && zt(), U = t[3], C = []
    for (let e = 0; e < U.length; e += 1) C[e] = Kt(qt(t, U, e))
    return {
      c() {
        r = p('div'), n = p('div'), i = p('div'), o = p('input'), a = g(), h = p('div'), c = p('input'), u = g(), m = p('div'), b = p('textarea'), w = g(), k = p('div'), T = p('button'), T.innerHTML = '<p class="text-gray-400 h-5">提交</p>', $ = g(), E = p('p'), E.textContent = '*如需回复, 请填写邮箱或其他有效联系方式.', O = g(), S = p('div'), x = p('div'), R && R.c(), j = g()
        for (let e = 0; e < C.length; e += 1) C[e].c()
        y(o, 'name', 'name'), y(o, 'id', 'name'), y(o, 'type', 'text'), o.required = !0, y(o, 'placeholder', '你的昵称'), y(o, 'class', 'appearance-none block w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white'), y(c, 'name', 'email'), y(c, 'id', 'mail'), y(c, 'type', 'text'), c.required = !0, y(c, 'placeholder', '你的邮箱(可选)*'), y(c, 'class', 'appearance-none block w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white'), y(b, 'name', 'comment'), y(b, 'id', 'comment'), y(b, 'type', 'text'), b.required = !0, y(b, 'placeholder', '评论内容'), y(b, 'class', 'h-44 appearance-none block w-full bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white'), y(m, 'class', 'sm:col-span-2'), y(T, 'class', 'inline-block bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-center rounded-lg outline-none transition duration-100 px-8 py-3'), y(E, 'class', 'mb-2 text-gray-400 text-xs'), y(k, 'class', 'sm:col-span-2 flex justify-between items-center'), y(n, 'class', 'max-w-screen-md grid sm:grid-cols-2 gap-4 mx-auto'), y(x, 'class', 'mt-10 space-y-4'), y(S, 'class', 'mx-auto max-w-screen-md')
      },
      m(e, s) {
        d(e, r, s), l(r, n), l(n, i), l(i, o), _(o, t[1]), l(n, a), l(n, h), l(h, c), _(c, t[2]), l(n, u), l(n, m), l(m, b), _(b, t[4]), l(n, w), l(n, k), l(k, T), l(k, $), l(k, E), l(r, O), l(r, S), l(S, x), R && R.m(x, null), l(x, j)
        for (let e = 0; e < C.length; e += 1) C[e].m(x, null)
        P || (A = [v(o, 'input', t[11]), v(c, 'input', t[12]), v(b, 'input', t[13]), v(T, 'click', t[14])], P = !0)
      },
      p(e, [t]) {
        if (2 & t && o.value !== e[1] && _(o, e[1]), 4 & t && c.value !== e[2] && _(c, e[2]), 16 & t && _(b, e[4]), e[0] ? R || (R = zt(), R.c(), R.m(x, j)) : R && (R.d(1), R = null), 8 & t) {
          let r
  ...
  function Xt(e, t, r) {
    let n
    u(e, $t, (e => r(3, n = e)))
    let { hostURL: s } = t, { postPath: i } = t, { supabaseUrl: o } = t, { anonKey: a } = t
    ...
    const p = async () => {
      const {
        data: e,
        error: t
      } = await h.from('comments').select().order('created_at', { ascending: !1 }).filter('postURL', 'in', `(${i})`).filter('show', 'is', !0)
      ...
      if (c && d) {
        ...
        }(c, l, d, i), e && (r(1, c = ''), r(2, l = ''), r(4, d = ''), p()), t && console.log(t)
      } else {
        alert('请填写完整信息')
      }
    }
    p()
    return e.$$set = e => {
      'hostURL' in e && r(6, s = e.hostURL), 'postPath' in e && r(7, i = e.postPath), 'supabaseUrl' in e && r(8, o = e.supabaseUrl), 'anonKey' in e && r(9, a = e.anonKey)
    ...
    return t = h(e), r = a[t] = o[t](e), {
      ...
      p(e, [i]) {
        ...
        t = h(e), t === c ? a[t].p(e, i) : (C = {
          ...
          a[c] = null
        })), C.r || s(C.c), C = C.p, r = a[t], r ? r.p(e, i) : (r = a[t] = o[t](e), r.c()), I(r, 1), r.m(n.parentNode, n))
      },
      i(e) {
        i || (I(r), i = !0)
      },
  ...
  function tr(e, t, r) {
    const n = window.location.pathname, s = window.location.host
    let { appUrl: i } = t, { supabaseUrl: o } = t, { anonKey: a } = t
    const h = {
      hostURL: s,
      postPath: n,
      supabaseUrl: o,
    ...
    return e.$$set = e => {
      'appUrl' in e && r(0, i = e.appUrl), "supabaseUrl" in e && r(3, o = e.supabaseUrl), "anonKey" in e && r(4, a = e.anonKey)
    }, [i, s, h, o, a]
  }

  let rr = document.getElementById("comments"), nr = rr.getAttribute("data-url") || "localhost:8080", sr = rr.getAttribute("supabase-url"), ir = rr.getAttribute("anon-key");
